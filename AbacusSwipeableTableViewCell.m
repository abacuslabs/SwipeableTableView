...
@property (nonatomic) UIPanGestureRecognizer *pr;
@end
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style
    ...
    self.pr.delegate = self;
    [self.contentView addGestureRecognizer:self.pr];
...
- (void)prepareForReuse {
    ...
    // Enabling/disabling the gesture recognizer cancels an existing touch
    self.pr.enabled = NO;
    self.pr.enabled = YES;
